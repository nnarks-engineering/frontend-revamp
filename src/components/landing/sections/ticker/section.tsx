...
export default function TickerSection() {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative py-20 bg-white overflow-hidden select-none"
    >
      ...
      <div className="relative z-10 w-full overflow-hidden">
        <motion.div 
          style={{ x }} 
          className="flex items-center gap-6 whitespace-nowrap pl-[10%] md:pl-[20%]"
        >
          {/* THE "PUSHER" - The Lead Item */}
          <div className="flex-shrink-0 h-20 md:h-24 px-8 md:px-10 rounded-full bg-primary flex items-center gap-4 md:gap-6 group cursor-pointer transition-all hover:scale-105 active:scale-95 shadow-xl shadow-primary/20">
            <div className="size-12 md:size-14 rounded-full bg-[#001E00] flex items-center justify-center text-primary">
              <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
            </div>
            <span className="font-bold text-black text-xl md:text-2xl">Send money</span>
          </div>
