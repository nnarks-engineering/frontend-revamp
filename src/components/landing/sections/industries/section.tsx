...
export default function IndustriesSection() {
  ...
  return (
    <section id="industries" className="relative w-full py-24 bg-white dark:bg-secondary-950 overflow-hidden">
      <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
        <LineJoinedDotSvg className="w-full h-full text-primary dark:text-secondary" />
      </div>
      <div className="max-w-[1600px] mx-auto px-4 md:px-8">
        <div className="flex relative flex-col items-center text-center">
          <motion.p
            ...
            viewport={{ once: true }}
            className="font-bold mb-4 font-millik text-4xl md:text-6xl dark:text-secondary-100"
          >
            Industries We Serve
          </motion.p>
          <motion.h2
            ...
            {industries.map((industry, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    " bg-white   rounded-  min-h-fit overflow-hidden group/card dark:border-x-secondary-950!",
                    isActive ? "w-[320px] md:w-[680px] md:border-x-4  !border-x-white   px-2 md:pl-0   bg-primary h-[420px] md:h-[450px] min-h-fit dark:bg-background-space" : "dark:bg-secondary-950 w-[180px] absolute cursor-pointer shadow-2xl p-2 md:w-[220px] h-[260px] md:h-[320px]"
                  )}
                >
                  <div className="relative h-full  w-full flex flex-col md:flex-row items-center">
                    <div className={cn(
                      "relative h-full transition-all  rounded- duration-500 overflow-hidden shrink-0",
                      ...
                      />
                        ...
                        {
                        isActive && (
                            <button className="absolute bg-background w-[90%] duration-300  mx-auto rounded-full my-auto p-1  h-fit inset-0 transition-all flex gap-4 items-center ">
                       <span className="size-8 flex items-center justify-center rounded-full text-primary bg-primary p-2 dark:bg-secondary-700">
                        <Armchair className="h-20 w-20 text-black dark:text-secondary-100" />
                       </span>
                       <p className=" font-medium  text-center drop-shadow-lg font-clash-display dark:text-secondary-100 ">
                        Explore more
                       </p>
                      </button>
                        )
        ...
        <div className="flex justify-center  gap-3">
          {industries.map((_, idx) => (
            ...
            type="button"
              ...
              className={cn(
                ...
                activeIndex === idx ? "w-10 bg-primary dark:bg-secondary-500" : "w-2 bg-primary-200 dark:bg-secondary-800"
              )}
          ...
          <div className="absolute inset-x-20 top-0 bg-gradient-to-r from-transparent via-primary-200 dark:via-secondary-600 to-transparent h-[2px] w-3/4 blur-sm" />
      <div className="absolute inset-x-20 top-0 bg-gradient-to-r from-transparent via-primary-300 dark:via-secondary-700 to-transparent h-px w-3/4" />
      <div className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-primary-200 dark:via-secondary-600 to-transparent h-[5px] w-2/4 blur-sm" />
      <div className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-primary dark:via-secondary-500 to-transparent h-px w-1/4" />
