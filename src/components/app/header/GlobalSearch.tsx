      ...
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent side="right" className="p-0">
          <div className="h-full flex flex-col">
            <div className="bg-primary-100/90 px-5 pt-5 pb-4 border-b border-primary-200/50">
              <div className="flex items-start justify-between gap-3 mb-3">
                <div>
                  <h2 className="text-3xl leading-none font-millik text-foreground">Need help?</h2>
                  <p className="text-foreground/75 mt-2 text-base">We've got everything you need right here.</p>
                </div>
                <button
                  type="button"
                  onClick={handleClose}
                  className="p-2 rounded-lg text-foreground/70 hover:text-foreground hover:bg-white/60 transition-colors"
                  aria-label="Close"
                >
                  <X className="w-5 h-5" />
                </button>
              ...
              <div className="relative">
                ...
                {search && (
                  <button
                    type="button"
                    onClick={() => setSearch("")}
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-0.5 text-muted-foreground/70 hover:text-foreground"
                  ...
                  <div className="space-y-1">
                    {defaultItems.map((item) => {
                      ...
                      return (
                        ...
                        >
                          <div className="mt-0.5 flex items-center justify-center w-8 h-8 rounded-md bg-primary-50 shrink-0 text-primary-700">
