...
export const MOCK_PROJECTS: ProjectDashboard[] = [
  {
    ...
    members: [
      { id: "m-001", project_id: "p-001", company_id: "c-001", email: "john@nnarks.com", role: "OWNER", status: "ACTIVE" },
      { id: "m-002", project_id: "p-001", company_id: "c-002", email: "sola@design.co", role: "PARTNER", status: "ACTIVE" },
    ],
    milestones: [
      {
        id: "ms-001", project_id: "p-001", title: "Discovery", description: "Initial research and requirements gathering",
        position: 1, status: "APPROVED", budget_amount: 420, start_date: "2026-02-10", end_date: "2026-02-20",
        estimated_duration: 10, required_evidence_types: ["DOCUMENT"], created_by: "USER", created_by_company_id: "c-001",
      },
      {
        id: "ms-002", project_id: "p-001", title: "Logo Design", description: "Brand identity and logo creation",
        position: 2, status: "UNDER_REVIEW", budget_amount: 840, start_date: "2026-02-21", end_date: "2026-03-06",
        estimated_duration: 14, required_evidence_types: ["IMAGE", "DOCUMENT"], created_by: "USER", created_by_company_id: "c-001",
      },
      {
        id: "ms-003", project_id: "p-001", title: "App Assets", description: "All mobile application UI assets and icons",
        position: 3, status: "IN_PROGRESS", budget_amount: 1500, start_date: "2026-03-07", end_date: "2026-03-28",
        estimated_duration: 21, required_evidence_types: ["IMAGE"], created_by: "USER", created_by_company_id: "c-001",
      },
      {
        id: "ms-004", project_id: "p-001", title: "Final Handoff", description: "Final delivery and asset transfer",
        position: 4, status: "PENDING", budget_amount: 1440, start_date: "2026-03-29", end_date: "2026-04-10",
  ...
  },
  {
    ...
    members: [
      { id: "m-003", project_id: "p-002", company_id: "c-003", email: "kwame@asante.dev", role: "OWNER", status: "ACTIVE" },
      { id: "m-004", project_id: "p-002", company_id: "c-001", email: "john@nnarks.com", role: "PARTNER", status: "ACTIVE" },
    ],
    milestones: [
      {
        id: "ms-005", project_id: "p-002", title: "Requirements", description: "API specification and documentation",
        position: 1, status: "APPROVED", budget_amount: 360, start_date: "2026-02-15", end_date: "2026-02-22",
        estimated_duration: 7, required_evidence_types: ["DOCUMENT"], created_by: "USER", created_by_company_id: "c-003",
      },
      {
        id: "ms-006", project_id: "p-002", title: "Implementation", description: "Core API development and integration",
        position: 2, status: "IN_PROGRESS", budget_amount: 900, start_date: "2026-02-23", end_date: "2026-03-23",
        estimated_duration: 28, required_evidence_types: ["DOCUMENT"], created_by: "USER", created_by_company_id: "c-003",
      },
      {
        id: "ms-007", project_id: "p-002", title: "Testing & Handoff", description: "QA testing and client handoff",
        position: 3, status: "PENDING", budget_amount: 540, start_date: "2026-03-24", end_date: "2026-04-15",
  ...
  },
  {
    ...
    members: [
      { id: "m-005", project_id: "p-003", company_id: "c-001", email: "john@nnarks.com", role: "OWNER", status: "ACTIVE" },
      { id: "m-006", project_id: "p-003", company_id: "c-004", email: "ama@mensah.io", role: "PARTNER", status: "ACTIVE" },
      { id: "m-007", project_id: "p-003", company_id: "c-005", email: "team@devcraft.studio", role: "PARTNER", status: "ACTIVE" },
    ],
    milestones: [
      {
        id: "ms-008", project_id: "p-003", title: "Wireframes", description: "UX wireframes and user flow design",
        position: 1, status: "APPROVED", budget_amount: 1500, start_date: "2026-01-28", end_date: "2026-02-10",
        estimated_duration: 13, required_evidence_types: ["IMAGE", "DOCUMENT"], created_by: "USER", created_by_company_id: "c-001",
      },
      {
        id: "ms-009", project_id: "p-003", title: "UI Development", description: "Frontend component development",
        position: 2, status: "IN_PROGRESS", budget_amount: 3000, start_date: "2026-02-11", end_date: "2026-03-25",
        estimated_duration: 42, required_evidence_types: ["IMAGE"], created_by: "USER", created_by_company_id: "c-001",
      },
      {
        id: "ms-010", project_id: "p-003", title: "Backend Integration", description: "API integration and data flow",
        position: 3, status: "PENDING", budget_amount: 2500, start_date: "2026-03-26", end_date: "2026-04-28",
        estimated_duration: 33, required_evidence_types: ["DOCUMENT"], created_by: "USER", created_by_company_id: "c-001",
      },
      {
        id: "ms-011", project_id: "p-003", title: "QA & Launch", description: "Quality assurance and production deployment",
        position: 4, status: "PENDING", budget_amount: 2500, start_date: "2026-04-29", end_date: "2026-05-28",
